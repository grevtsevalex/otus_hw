...
const (
	...
	EventService_GetAll_FullMethodName = "/event.EventService/GetAll"
)
...
func (c *eventServiceClient) GetAll(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GetAllResponse, error) {
...
func (UnimplementedEventServiceServer) GetAll(context.Context, *empty.Empty) (*GetAllResponse, error) {
...
func _EventService_GetAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventServiceServer).GetAll(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
