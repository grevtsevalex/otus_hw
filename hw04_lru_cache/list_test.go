...
func TestOneElementList(t *testing.T) {
	l := NewList()
	l.PushFront(10)
...
func TestRemoveFrontElement(t *testing.T) {
	l := NewList()
	l.PushBack(10)
	l.PushBack(20)
	l.PushBack(30)
...
func TestRemoveBackElement(t *testing.T) {
	l := NewList()
	l.PushBack(10)
	l.PushBack(20)
	l.PushBack(30)
...
func TestMoveBackElementToFront(t *testing.T) {
	l := NewList()
	l.PushBack(10)
	l.PushBack(20)
